...
import { AspectRatio, Button, SearchArea, Slider } from '@/components'
import {
  MapPinIcon,
  PhoneIcon,
  CheckIcon,
        ...
        <div className="px-4 pb-4 my-2 divide-y divide-solid divide-slate-300 bg-white">
          <section className="pt-4">
            ...
            <div className="mb-4">
              ...
              <div className="mb-2">
                <h3>入住時間：{hotel.checkInTime}</h3>
              </div>
              <div className="mb-2">
                <h3>退房時間：{hotel.checkOutTime}</h3>
              </div>
            </div>
          </section>

          <section className="pt-4">
            <h3 className="font-bold text-lg mb-2">房型</h3>
                ...
                >
                  <div className="w-2/3 border-r border-r-slate-400 p-6">
                    ...
                    {room.hasBreakfast ? (
                      ...
                      <p className="text-slate-500 mb-2 line-through">
                        不含早餐
                      </p>
                    )}
          ...
          <section className="pt-4">
            <h3 className="font-bold text-lg mb-2">設施</h3>
          ...
          <section className="text-sm pt-4">
            <h3 className="font-bold text-lg mb-2">退訂政策</h3>
          ...
          <section className="text-sm pt-4">
            <h3 className="font-bold text-lg mb-2">常見問題</h3>
            <article className="mb-4">
              <h4 className="font-medium text-base mb-2">
                ▶ 旅宿附近有哪些景點或地標？
              </h4>
